  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      ...
      <p className="text-sm mt-2">
        This privacy policy (policy) will help you understand how [name] (us,
        we, our) uses and protects the data you provide to us when you visit and
        use [website] (website, service). We reserve the right to change this
        policy at any given time, of which you will be promptly updated. If you
      ...
      <p className="text-sm">
        ...
        completely removed from our systems. Please note that cookies dont allow
        us to gain control of your computer in any way. They are strictly used
        to monitor which pages you find useful and which you do not so that we
        can provide a better experience for you. If you want to disable cookies,
        you can do it by accessing the settings of your internet browser.
